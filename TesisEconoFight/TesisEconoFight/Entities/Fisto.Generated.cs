...
{
	public partial class Fisto : TesisEconoFight.Entities.Especial, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionFisto;
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("FistoStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/fisto/animacionfisto.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionFisto = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/fisto/animacionfisto.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/fisto/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/fisto/scenefile.scnx", ContentManagerName);
			}
	...
	// Extra classes
	public static class FistoExtensionMethods
	{
	}
