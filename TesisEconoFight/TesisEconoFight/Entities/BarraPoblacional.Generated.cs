...
{
	public partial class BarraPoblacional : TesisEconoFight.Entities.BarraPadre, IDestroyable
	{
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("BarraPoblacionalStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class BarraPoblacionalExtensionMethods
	{
	}
