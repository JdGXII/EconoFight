...
{
	public partial class TasaInteres : PositionedObject, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList InteresAnimacion;
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("TasaInteresStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/tasainteres/interesanimacion.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				InteresAnimacion = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/tasainteres/interesanimacion.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/tasainteres/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/tasainteres/scenefile.scnx", ContentManagerName);
			}
		...
		public static void PreloadStateContent (VariableState state, string contentManagerName)
		{
			...
			{
				case  VariableState.InteresBajo:
					throwaway = "InteresBajo";
					break;
				case  VariableState.InteresNatural:
					throwaway = "InteresNatural";
					break;
				case  VariableState.InteresAlto:
					throwaway = "InteresAlto";
					break;
			}
		}
	...
	// Extra classes
	public static class TasaInteresExtensionMethods
	{
	}
