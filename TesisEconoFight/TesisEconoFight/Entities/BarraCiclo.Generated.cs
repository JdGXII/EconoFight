...
{
	public partial class BarraCiclo : TesisEconoFight.Entities.BarraPadre, IDestroyable
	{
        ...
        public BarraCiclo(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public BarraCiclo(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("BarraCicloStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class BarraCicloExtensionMethods
	{
	}
