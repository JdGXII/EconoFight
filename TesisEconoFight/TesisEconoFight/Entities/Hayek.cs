...
namespace TesisEconoFight.Entities
{
	...
	public partial class Hayek
	{
        VariableState lastState;
        BarraHP HP;
        BarraSensorial sensorial;
        //SuperBarra completa;
        ...
        public override void LlenarBarra(BarraPadre barra)
        {
            ListaSuperB.Add(barra);
        }
        ...
        {
            ListaSuperB[0].UpdateFillFlip();
            base.ActualizarBarraFlip();
        }
        /*public override void LlenarBarra()
        {
            ListaSuperB[0].UpdateFill();
        }*/
        ...
        public BarraSensorial getSensorial()
        {
            return this.sensorial;
        }
        ...
        /*private void GolpeArriba(Xbox360GamePad control)
        {
            ...
            if (CurrentState == VariableState.GolpeArriba && this.Sprite.CurrentFrameIndex == 1)
            {
                Golpe.ScaleX = 0;
                Golpe.ScaleY = 0;
                Golpe.XVelocity=0;
        ...
        private void GolpeArribaFlip(Xbox360GamePad control)
        {
            ...
            if (CurrentState == VariableState.FlipGolpeArriba && this.Sprite.CurrentFrameIndex == 1)
            {
                Golpe.ScaleX = 0;
                Golpe.ScaleY = 0;
              Golpe.XVelocity=0;
        ...
        public override void RecibirDaño(float daño)
        {
            ...
            ListaSuperB[0].VaciarBarraGolpe();
        ...
        public override void RecibirDañoFlip(float daño)
        {
            ...
            ListaSuperB[0].VaciarBarraGolpeFlip();
        ...
        private void AtaqueEspecial1(Xbox360GamePad control)
        {
            ...
            if (CurrentState == VariableState.Especial1 && this.Sprite.CurrentFrameIndex == 3)
            {
            ...
            if (CurrentState == VariableState.Parado)
            {
                if (ListaSuperB[0].getTipo()=="Full")
                {
                    if (ListaSuperB[0].getCantidadActual() == 100)
                    {
                        ...
                        {
                            ListaSuperB[0].VaciarBarraPoruso();
                            //hacer super ataque
      ...
      ///////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void AtacarAI()
        {
            ...
            /*if (CurrentState == VariableState.FlipEspecial1 && this.Sprite.CurrentFrameIndex == 2)
            {
                ...
                Proyectil proyectil = new Proyectil(ContentManagerName);
                proyectil.setPosicion(this.X - 3, this.Y, this.EnemigoX);
                proyectil.setTipo(this.Estado);
                this.ListaAtaques.Add(proyectil);
            }
            ...
            else if (CurrentState == VariableState.FlipEspecial2 && this.Sprite.CurrentFrameIndex == 2)
            {
                ...
                {
                    Precios precio = new Precios(ContentManagerName);
                    precio.setPosicion(this.X - 2 * i, this.Y + 5, this.EnemigoX, this.Y);
                    this.ListaAtaques.Add(precio);
                    // precio.Destroy();
