...
{
	public partial class Malthus : TesisEconoFight.Entities.Player, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionMalthus;
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MalthusStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/malthus/animacionmalthus.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionMalthus = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/malthus/animacionmalthus.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/malthus/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/malthus/scenefile.scnx", ContentManagerName);
			}
	...
	// Extra classes
	public static class MalthusExtensionMethods
	{
	}
