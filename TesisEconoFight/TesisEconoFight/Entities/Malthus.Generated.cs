...
{
	public partial class Malthus : TesisEconoFight.Entities.Player, FlatRedBall.Graphics.IDestroyable
	{
		...
		public Entities.Malthus.VariableState CurrentState
		{
			get
			{
			...
			set
			{
				...
				switch(CurrentState)
				{
					...
					case  VariableState.FlipAgachado:
						CurrentChainName = "FlipAgacharse";
						break;
		...
		protected static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionMalthus;
        ...
        public Malthus(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public Malthus(string contentManagerName, bool addToManagers) :
		...
		protected override void InitializeEntity(bool addToManagers)
		{
			...
			Cuerpo.Name = "Cuerpo";
			Sprite = SceneFile.Sprites.FindByName("malthus 151").Clone();
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("MalthusStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/malthus/animacionmalthus.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionMalthus = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/malthus/animacionmalthus.achx", ContentManagerName);
				if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/malthus/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/malthus/scenefile.scnx", ContentManagerName);
			}
		...
		public static new void UnloadStaticContent ()
		{
			...
			if (LoadedContentManagers.Count == 0)
			{
				if (AnimacionMalthus != null)
				{
					AnimacionMalthus= null;
				}
				if (SceneFile != null)
				{
		...
		public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue)
		{
			...
			switch(firstState)
			{
				...
				case  VariableState.Agachado:
					if (interpolationValue < 1)
					{
						this.CurrentChainName = "Agacharse";
					}
					break;
				case  VariableState.BloqueoArriba:
					if (interpolationValue < 1)
				...
				case  VariableState.FlipAgachado:
					if (interpolationValue < 1)
					{
						this.CurrentChainName = "FlipAgacharse";
					}
					break;
				case  VariableState.FlipBloqueoArriba:
					if (interpolationValue < 1)
		...
		public static new object GetStaticMember (string memberName)
		{
			switch(memberName)
			{
				case  "AnimacionMalthus":
					return AnimacionMalthus;
				case  "SceneFile":
					return SceneFile;
			}
			return null;
