...
{
	public partial class Malnutrido
	{
        float Xenemigo;
        double TimeCreated;
		...
		{
            Atacar();
            if (TimeManager.CurrentTime - TimeCreated >= 15.0)
            {
                this.Destroy();
            }
            if (this.Vida <= 0)
        ...
        public override void setVida(float damage)
        {
