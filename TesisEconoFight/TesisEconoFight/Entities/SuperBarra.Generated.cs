...
{
	public partial class SuperBarra : TesisEconoFight.Entities.BarraPadre, IDestroyable
	{
        ...
        public SuperBarra(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public SuperBarra(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SuperBarraStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class SuperBarraExtensionMethods
	{
	}
