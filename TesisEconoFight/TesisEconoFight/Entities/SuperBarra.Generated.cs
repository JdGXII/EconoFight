...
{
	public partial class SuperBarra : TesisEconoFight.Entities.BarraPadre, FlatRedBall.Graphics.IDestroyable
	{
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SuperBarraStaticUnload", UnloadStaticContent);
