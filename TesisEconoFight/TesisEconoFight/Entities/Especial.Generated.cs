...
{
	public partial class Especial : PositionedObject, IDestroyable
	{
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("EspecialStaticUnload", UnloadStaticContent);
	...
	// Extra classes
	public static class EspecialExtensionMethods
	{
	}
