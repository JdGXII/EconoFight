...
{
	public partial class Precios : TesisEconoFight.Entities.Especial, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionPrecio;
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("PreciosStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/precios/animacionprecio.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionPrecio = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/precios/animacionprecio.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/precios/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/precios/scenefile.scnx", ContentManagerName);
			}
	...
	// Extra classes
	public static class PreciosExtensionMethods
	{
	}
