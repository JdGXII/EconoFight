...
{
	public partial class Kursor : PositionedObject, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionCursor;
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("KursorStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/kursor/animacioncursor.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionCursor = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/kursor/animacioncursor.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/kursor/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/kursor/scenefile.scnx", ContentManagerName);
			}
	...
	// Extra classes
	public static class KursorExtensionMethods
	{
	}
