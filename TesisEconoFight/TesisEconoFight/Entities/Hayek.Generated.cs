...
namespace TesisEconoFight.Entities
{
	public partial class Hayek : TesisEconoFight.Entities.Player, IDestroyable
	{
        ...
        public Hayek(string contentManagerName, bool addToManagers) :
...
// Generated AddToManagers
		...
		public override void Activity()
		{
			...
			{
				if (i < ListaSuperB.Count)
				{
					// We do the extra if-check because activity could destroy any number of entities
					ListaSuperB[i].Activity();
				}
			}
		...
		public override void ConvertToManuallyUpdated ()
		{
			...
			for (int i = 0; i < ListaSuperB.Count; i++)
			{
				ListaSuperB[i].ConvertToManuallyUpdated();
			}
