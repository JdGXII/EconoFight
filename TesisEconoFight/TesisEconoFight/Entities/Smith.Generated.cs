...
{
	public partial class Smith : TesisEconoFight.Entities.Player, FlatRedBall.Graphics.IDestroyable
	{
		...
		public Entities.Smith.VariableState CurrentState
		{
			get
			{
		...
		protected static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionSmith;
        ...
        public Smith(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public Smith(string contentManagerName, bool addToManagers) :
		...
		protected override void InitializeEntity(bool addToManagers)
		{
			...
			Cuerpo.Name = "Cuerpo";
			Sprite = SceneFile.Sprites.FindByName("smith 101").Clone();
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SmithStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/smith/animacionsmith.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionSmith = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/smith/animacionsmith.achx", ContentManagerName);
				if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/smith/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/smith/scenefile.scnx", ContentManagerName);
			}
