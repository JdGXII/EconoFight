...
{
	public partial class Smith : TesisEconoFight.Entities.Player, IDestroyable
	{
		...
		private static FlatRedBall.Graphics.Animation.AnimationChainList AnimacionSmith;
...
// Generated AddToManagers
		...
		public static new void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("SmithStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/smith/animacionsmith.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimacionSmith = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/smith/animacionsmith.achx", ContentManagerName);
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/entities/smith/scenefile.scnx", ContentManagerName))
				{
					registerUnload = true;
				}
				SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/entities/smith/scenefile.scnx", ContentManagerName);
			}
	...
	// Extra classes
	public static class SmithExtensionMethods
	{
	}
