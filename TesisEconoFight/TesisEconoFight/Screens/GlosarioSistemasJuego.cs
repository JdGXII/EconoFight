...
{
	public partial class GlosarioSistemasJuego
	{
        ...
        {
            if (CurrentState == VariableState.P1  && GlobalData.getControl1().ButtonPushed(Xbox360GamePad.Button.B))
            {
            ...
            else if (CurrentState == VariableState.P4  && GlobalData.getControl1().ButtonPushed(Xbox360GamePad.Button.B))
            {
        ...
        private void Navegar()
        {
            ...
            else if (CurrentState == VariableState.P3  && GlobalData.getControl1().ButtonPushed(Xbox360GamePad.Button.A))
            {
                CurrentState = VariableState.P4;
            }
