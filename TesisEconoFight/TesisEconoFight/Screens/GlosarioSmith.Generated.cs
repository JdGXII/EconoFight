...
{
	public partial class GlosarioSmith : Screen
	{
		// Generated Fields
		#if DEBUG
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariosmith/opciones.shcx", ContentManagerName))
			{
			}
			Opciones = FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariosmith/opciones.shcx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/glosariosmith/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/glosariosmith/scenefile.scnx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariosmith/animacionmundo.achx", ContentManagerName))
			{
			}
			AnimacionMundo = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariosmith/animacionmundo.achx", ContentManagerName);
