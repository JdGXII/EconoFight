...
{
	public partial class GlosarioHayek : FlatRedBall.Screens.Screen
	{
		// Generated Fields
		#if DEBUG
		...
		public Screens.GlosarioHayek.VariableState CurrentState
		{
			get
			{
		...
		protected FlatRedBall.Graphics.Animation.AnimationChainList AnimacionPantalla;
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariohayek/opciones.shcx", ContentManagerName))
			{
			}
			Opciones = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariohayek/opciones.shcx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/glosariohayek/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/glosariohayek/scenefile.scnx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariohayek/animacionpantalla.achx", ContentManagerName))
			{
			}
			AnimacionPantalla = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariohayek/animacionpantalla.achx", ContentManagerName);
			KursorInstance = new TesisEconoFight.Entities.Kursor(ContentManagerName, false);
			KursorInstance.Name = "KursorInstance";
			Pantalla = SceneFile.Sprites.FindByName("glosario hayek 11");
