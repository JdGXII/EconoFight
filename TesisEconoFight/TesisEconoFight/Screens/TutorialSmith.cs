...
{
	public partial class TutorialSmith
	{
        ...
        private void Salir()
        {
            /*if (CurrentState == VariableState.P2 && GlobalData.getControl1().ButtonDown(Xbox360GamePad.Button.A))
            {
                MoveToScreen(typeof(MundoSmith).FullName);
            }*/
