...
{
	public partial class GlosarioMalthus : FlatRedBall.Screens.Screen
	{
		// Generated Fields
		#if DEBUG
		...
		public Screens.GlosarioMalthus.VariableState CurrentState
		{
			get
			{
		...
		public GlosarioMalthus()
			: base("GlosarioMalthus")
		{
		}
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariomalthus/opciones.shcx", ContentManagerName))
			{
			}
			Opciones = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariomalthus/opciones.shcx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/glosariomalthus/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/glosariomalthus/scenefile.scnx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariomalthus/animacionmundo.achx", ContentManagerName))
			{
			}
			AnimacionMundo = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariomalthus/animacionmundo.achx", ContentManagerName);
			KursorInstance = new TesisEconoFight.Entities.Kursor(ContentManagerName, false);
			KursorInstance.Name = "KursorInstance";
			Pantalla = SceneFile.Sprites.FindByName("glosario malthus 11");
