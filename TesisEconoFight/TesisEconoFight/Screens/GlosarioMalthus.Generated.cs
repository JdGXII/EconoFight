...
{
	public partial class GlosarioMalthus : Screen
	{
		// Generated Fields
		#if DEBUG
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariomalthus/opciones.shcx", ContentManagerName))
			{
			}
			Opciones = FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariomalthus/opciones.shcx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/glosariomalthus/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/glosariomalthus/scenefile.scnx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariomalthus/animacionmundo.achx", ContentManagerName))
			{
			}
			AnimacionMundo = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariomalthus/animacionmundo.achx", ContentManagerName);
