...
{
	public partial class GlosarioKeynes : Screen
	{
		// Generated Fields
		#if DEBUG
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariokeynes/opciones.shcx", ContentManagerName))
			{
			}
			Opciones = FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/glosariokeynes/opciones.shcx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/glosariokeynes/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/glosariokeynes/scenefile.scnx", ContentManagerName);
			if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariokeynes/animacionmundo.achx", ContentManagerName))
			{
			}
			AnimacionMundo = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/glosariokeynes/animacionmundo.achx", ContentManagerName);
