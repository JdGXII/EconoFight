...
{
	public partial class MundoMalthus : FlatRedBall.Screens.Screen
	{
		// Generated Fields
		#if DEBUG
		...
		private TesisEconoFight.Entities.Malthus MalthusInstance;
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/mundomalthus/limitesmundo.shcx", ContentManagerName))
			{
			}
			LimitesMundo = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Math.Geometry.ShapeCollection>(@"content/screens/mundomalthus/limitesmundo.shcx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/mundomalthus/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/mundomalthus/scenefile.scnx", ContentManagerName);
			Fondo = SceneFile.Sprites.FindByName("london-bridge1");
			MalthusInstance = new TesisEconoFight.Entities.Malthus(ContentManagerName, false);
			MalthusInstance.Name = "MalthusInstance";
...
// Generated AddToManagers
		public override void AddToManagers ()
		{
			...
			MalthusInstance.AddToManagers(mLayer);
		...
		public override void Destroy()
		{
			...
			if (MalthusInstance != null)
			{
				MalthusInstance.Destroy();
				MalthusInstance.Detach();
			}
		...
		public virtual void RemoveFromManagers ()
		{
			...
			MalthusInstance.RemoveFromManagers();
		...
		public virtual void AssignCustomVariables (bool callOnContainedElements)
		{
			...
			{
				MalthusInstance.AssignCustomVariables(true);
		...
		public virtual void ConvertToManuallyUpdated ()
		{
			...
			MalthusInstance.ConvertToManuallyUpdated();
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			#endif
			TesisEconoFight.Entities.Malthus.LoadStaticContent(contentManagerName);
