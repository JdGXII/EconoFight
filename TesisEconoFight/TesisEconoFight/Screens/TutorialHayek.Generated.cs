...
{
	public partial class TutorialHayek : FlatRedBall.Screens.Screen
	{
		// Generated Fields
		#if DEBUG
		...
		public Screens.TutorialHayek.VariableState CurrentState
		{
			get
			{
        ...
        public override void Initialize(bool addToManagers)
        {
			...
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/tutorialhayek/animacionpantalla.achx", ContentManagerName))
			{
			}
			AnimacionPantalla = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/screens/tutorialhayek/animacionpantalla.achx", ContentManagerName);
			if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Scene>(@"content/screens/tutorialhayek/scenefile.scnx", ContentManagerName))
			{
			}
			SceneFile = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Scene>(@"content/screens/tutorialhayek/scenefile.scnx", ContentManagerName);
			Pantalla = SceneFile.Sprites.FindByName("pantalla tutorial hayek 11");
