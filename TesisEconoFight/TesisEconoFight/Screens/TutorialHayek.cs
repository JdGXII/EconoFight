...
{
	public partial class TutorialHayek
	{
        ...
        private void Salir()
        {
            /*if (CurrentState == VariableState.P3 && GlobalData.getControl1().ButtonPushed(Xbox360GamePad.Button.A))
            {
                MoveToScreen(typeof(MundoHayek).FullName);
            }*/
